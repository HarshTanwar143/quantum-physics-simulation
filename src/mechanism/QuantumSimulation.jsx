        ...
        <div className="bg-blue-50 p-4 rounded">
          ...
          <div className="flex items-center space-x-2">
            ...
            <input
              ...
              className="flex-1"
            />
            <span className="text-sm w-12">{customAngle}°</span>
            <button 
              onClick={() => applyGate('R')} 
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center p-6 border-2 border-dashed border-blue-300 rounded-lg">
            ...
            <div className="text-6xl mb-4">{particle1}</div>
            <button 
          ...
          <div className="text-center p-6 border-2 border-dashed border-red-300 rounded-lg">
            ...
            <div className="text-6xl mb-4">{particle2}</div>
            <button 
